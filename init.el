...
<link rel=\"stylesheet\" type=\"text/css\" href=\"https://dou-meishi.github.io/orgcss/dou-org.css\"/>")
 ...
 '(package-selected-packages
   '(cnfonts solarized-theme yasnippet-snippets markdown-mode company-jedi elpy org-bullets dash-functional dash csv-mode))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#002b36" :foreground "#839496" :inverse-video nil :box nil :strike-through nil :extend nil :overline nil :underline nil :slant normal :weight normal :height 120 :width normal :foundry "outline" :family "文泉驿等宽微米黑"))))
 '(fixed-pitch ((t (:family "文泉驿等宽微米黑"))))
 '(italic ((t (:slant italic :family "Bookman Old Style"))))
 ...
 '(org-level-1 ((t (:inherit default :weight bold :family "微软雅黑" :height 1.75))))
 ...
 '(org-table ((t (:foreground "#859900" :family "等距更纱黑体 SC"))))
 '(org-verbatim ((t (:foreground "#d33682" :family "DejaVu Sans Mono"))))
 '(variable-pitch ((t (:font "微软雅黑")))))
...
;; set font for character U226F
(set-fontset-font "fontset-default" '(#x262f . #x262f) "等距更纱黑体 SC")
(set-fontset-font "fontset-default" '(#x25c9 . #x25c9) "等距更纱黑体 SC")
(set-fontset-font "fontset-default" '(#x273f . #x273f) "等距更纱黑体 SC")
(set-fontset-font "fontset-default" '(#x21ba . #x21ba) "等距更纱黑体 SC")
(set-fontset-font "fontset-default" 'han (font-spec :name "文泉驿等宽微米黑" :weight 'bold))
